...
import com.esrcitazione.hotelhub.utils.Recensioni
import com.esrcitazione.hotelhub.adapter.RecensioniAdapter
            ...
            override fun onResponse(call: Call<JsonObject>, response: Response<JsonObject>) {
                if (response.isSuccessful) {
                    ...
                    if (result != null && result.size() > 0) {
                        val averageRatingElement = result[0].asJsonObject["average_rating"]
                        if (!averageRatingElement.isJsonNull) {
                            val averageRating = averageRatingElement.asFloat
            ...
            override fun onResponse(call: Call<JsonObject>, response: Response<JsonObject>) {
                if (response.isSuccessful) {
                    ...
                    if (result != null && result.size() > 0) {
                        ...
                        val percentualeCinqueStelle = if (jsonObject.has("percentuale_cinque_stelle") && !jsonObject.get("percentuale_cinque_stelle").isJsonNull)
                            jsonObject.get("percentuale_cinque_stelle").asDouble
                        else 0.0
                        val percentualeQuattroStelle = if (jsonObject.has("percentuale_quattro_stelle") && !jsonObject.get("percentuale_quattro_stelle").isJsonNull)
                            jsonObject.get("percentuale_quattro_stelle").asDouble
                        else 0.0
                        val percentualeTreStelle = if (jsonObject.has("percentuale_tre_stelle") && !jsonObject.get("percentuale_tre_stelle").isJsonNull)
                            jsonObject.get("percentuale_tre_stelle").asDouble
                        else 0.0
                        val percentualeDueStelle = if (jsonObject.has("percentuale_due_stelle") && !jsonObject.get("percentuale_due_stelle").isJsonNull)
                            jsonObject.get("percentuale_due_stelle").asDouble
                        else 0.0
                        val percentualeUnaStella = if (jsonObject.has("percentuale_una_stella") && !jsonObject.get("percentuale_una_stella").isJsonNull)
                            jsonObject.get("percentuale_una_stella").asDouble
                        else 0.0
